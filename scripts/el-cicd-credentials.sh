...
_refresh_credentials() {
    ...
    _push_deploy_key_to_github el-CICD ${EL_CICD_MASTER_NAMESPACE} ${EL_CICD_SSH_READ_ONLY_DEPLOY_KEY_FILE}

    echo
    echo "Adding read only deploy key for el-CICD-config"
    _push_deploy_key_to_github el-CICD-config ${EL_CICD_MASTER_NAMESPACE} ${EL_CICD_CONFIG_SSH_READ_ONLY_DEPLOY_KEY_FILE}
