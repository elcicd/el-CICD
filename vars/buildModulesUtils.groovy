...
def getSelectedModules(def projectInfo, def args) {
    def DEPLOY_TO_NAMESPACE = 'Deploy Foo Namespace'
    ...
    projectInfo.deployToNamespace = cicdInfo.get(DEPLOY_TO_NAMESPACE)
    projectInfo.gitBranch = cicdInfo.get(GIT_BRANCH)
    projectInfo.cleanNamespace = cicdInfo.get(CLEAN_NAMESPACE)
